...
class game(QObject):
    ...
    # 从者技能1-9,*[0]y轴位置
    savent_skill = [550,40,135,230,360,450,545,675,770,865]
    # 衣服技能,*[0]y轴位置
    clothes_skill = [285,880,965,1055]
    # 技能选人,*[0]y轴位置
    skill_select = [325,230,540,850]
    # 指令卡位置：宝具[0]y轴位置
    baojv = [140,350,580,810]
    ...
    def select_savent_skill(self, op):
        ''' 从者技能选择 '''
        self.tap_screen(self.savent_skill[op],self.savent_skill[0],50,50)
        time.sleep(3)
    ...
    def select_clothes_skill(self, op):
        ...
        time.sleep(1)
        self.tap_screen(self.clothes_skill[op],self.clothes_skill[0],50,50)
        time.sleep(2)

    def select_savent(self,op):
        ''' 从者选择 '''
        self.tap_screen(self.skill_select[op],self.skill_select[0],190,205)
        time.sleep(3)
    ...
    def card_select(self,op):
        ''' 从者指令卡选择，从攻击开始，op:宝具,指令卡默认:2,3 '''
        self.tap_screen(1090,565,80,80)
        time.sleep(1)
        self.tap_screen(self.baojv[op],self.baojv[0],130,120)
    ...
    def battle_1(self):
        ...
        self.card_select(1)
        # 闪闪祭 正赛
        # self.select_savent_skill(1)
        # self.select_savent_skill(7)
        # self.select_savent(2)
    ...
    def battle_finish(self):
        ...
        time.sleep(2)
        self.tap_screen(980,645,260,60)# 战利品
...
# UI更新线程
# TODO: 使用类直播的方式获取手机屏幕的内容（adb截图效率太低）
class uiThread(QThread):
    ...
    def run(self):
        while self.flag:
            ...
            del image_bytes,image,height,width,bytesPerline,qImg,qPix
    def exithread(self):
        self.flag = False
